...
```json
{
  "premium_monthly": 31.4,
  "premium_monthly_with_extra_help": 0.0,
  "giveback_monthly": 15.0,
  "otc_benefit_quarterly": 50.0,
  "medical_deductible": 990.0,
  "medical_deductible_with_medicaid": 0.0
}
```
